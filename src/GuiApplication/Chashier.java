 ...
 * @author ROCKSTAR
 */
public class Chashier extends javax.swing.JFrame implements Runnable{
...
private String userename="";
    public Chashier(String username) {
    ...
    private void initComponents() {
        ...
        jLabel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 13), new java.awt.Color(0, 153, 0))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            Connection con=DbConnection.getConnection();
            PreparedStatement pst=con.prepareStatement("update login set password=? ,status=? where username=?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
           // Connection con=MyConnection.getConnection();
            PreparedStatement pst=con.prepareStatement("INSERT INTO `LOGIN`(`username`,`password`,`status`) VALUES (?,?,?)");
           ...
           if(res>0)
               JOptionPane.showMessageDialog(null," New Cashier Created Successfully");
           jTextField1.setText(" ");
           jPasswordField1.setText("");
